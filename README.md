...
- **REDESIGN IN FLIGHT (2026-07-08)**: the founder rejected the shipped design ("sections forcefully put together") and mandated a ground-up immersive R3F rebuild, copy unchanged. Stage A delivered: **4 wireframe directions** in `design-concepts/round-2-immersive/` (founder pick pending) + founder model kit in `3d-handoff/`. Plan: `docs/redesign-plan-2026-07.md`. **Hard gate: no site code changes until the founder picks a direction.** The site in `site/` is untouched meanwhile.
