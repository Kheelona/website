...
- **/stories** + 4 articles — `site/lib/stories.ts`: "Why three to six are the years that matter most", "Screen-free does not mean silent", "How children learn by talking", "What to look for in a safe AI toy". Each ends with a soft invite, never a hard sell.
