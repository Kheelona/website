 ...
 * Source: registry item `primitives-effects-tilt` @ imskyleen/animate-ui@efeb96ffd7a3
 * License: MIT + Commons Clause (index: components/vendor/README.md)
 * Brand modifications: imports resolved to sibling vendored files; otherwise
 * verbatim. Capability gating (touch/reduced-motion) lives in the brand
 * wrapper components/ui/TiltCard.tsx, not here. */
