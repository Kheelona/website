...
export function Hero() {
  return (
    <Section wash="cream" className="overflow-x-clip">
      ...
      <Shape kind="flower13" color="#29A0D7" className="opacity-40 absolute right-[6%] top-[16%] w-[64px] md:w-[90px]" />
      <Shape kind="squircle" color="#EF762F" className="opacity-40 absolute -left-10 bottom-[20%] w-[120px] md:w-[180px]" />
