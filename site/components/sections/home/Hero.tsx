...
export function Hero() {
  return (
    <Section wash="cream" className="overflow-x-clip">
      <Shape kind="flower5" color="#F1A23B" className="opacity-25 absolute left-[4%] top-[8%] w-[90px] md:w-[130px]" />
      <Shape kind="flower13" color="#3AA4E5" className="opacity-25 absolute right-[6%] top-[16%] w-[64px] md:w-[90px]" />
      <Shape kind="squircle" color="#1ABC9C" className="opacity-25 absolute -left-10 bottom-[20%] w-[120px] md:w-[180px]" />
