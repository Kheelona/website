...
export const SETUP_STEPS = [
  { n: "01", title: "Unbox and charge.", body: "Lumi arrives ready. Plug in the charger and let it drink while you do the next step.", color: "text-orange-ink" },
  ...
  { n: "02", title: "Open the parent app.", body: "Connect Lumi to your home WiFi, set the languages you speak at home, pick the topics that are open, and set quiet hours. Five minutes, once.", color: "text-blue-ink" },
