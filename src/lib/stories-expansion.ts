...
export const EXPANSION: Story[] = [
  {
    ...
    paragraphs: [
      ...
      { p: "That is the gap we are building [Kheelu](/products/kheelu) for: a screen-free friend that talks, in the languages you speak at home. But screen or no screen, the hour is yours to place. The talking is the part that cannot be skipped. If you want the named rules parents pass around, and which ones have evidence behind them, read [the 3-6-9-12 rule and the others parents swear by](/stories/screen-time-rules-parents-swear-by)." },
    ],
    sources: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      { p: "Add one more for a toy that lives in a bedroom: when is the microphone on? The only good answer is when your child says a wake word, and off the rest of the time. Our longer version, with what India's data-protection law now requires of anyone holding a child's data, is [the safe AI toy checklist](/stories/what-to-look-for-in-a-safe-ai-toy)." },
