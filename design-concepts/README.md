...
High-res faithful Lumi product renders (`Design/product-images/generated-2026-07/`) were produced with **Gemini Nano Banana Pro** (gemini.google.com, founder's Pro account) driven via Chrome automation; the shipped `site/public/product/lumi-blue.png` comes from this pipeline (1792×2400 source, cut with tools/cutout, shipped at 1113×1600).
